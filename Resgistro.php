...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
                <a class="float-right nav-link" href="Resgistro.php">Registrarse<span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="container mt-5"style="">
        <div class="row">
          <div class="col col-12 mt-4">
                <h1><center>BIENVENIDO POR FAVOR INGRESE SUS DATOS PARA EL REGISTRO</center></h1>
                <form method="POST">
                    ...
                    <div class="mx-auto" style="width: 300px;">
                        <a href="FaseOne.php" name="Data" type="submit" class="btn btn-primary btn-lg btn-block">GUARDAR</a>
                    </div>
                </form>
              </div> 
           </div>
